                    ...
                    <div className="dropdown mb-5">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenu1">
                            ...
                            <li onClick={ () => this.onClick('status', 1)}>
                                <a role="button" className={(this.props.sortBy === 'status' && this.props.sortValue === 1) ? 'sort_selected' : ''} > Kích hoạt </a>
                            </li>

                            <li onClick={ () => this.onClick('status', -1)}>
                                <a role="button" className={(this.props.sortBy === 'status' && this.props.sortValue === -1) ? 'sort_selected' : ''} > Ẩn</a>
                            </li>
                        </ul>
                    </div>
                </div>
